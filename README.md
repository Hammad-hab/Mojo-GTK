...
- `test-demos.py`: Builds and runs all the demos.
...
- pass that static method as a callback
...
var gtk_compatible = (App.activate)
```
...
- use `mojo build` (currently the code uses `external_call`)
